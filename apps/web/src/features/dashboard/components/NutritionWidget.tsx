...
import { getDailyNutrition } from '@/features/nutrition/services/nutrition'
...
export function NutritionWidget({ userId }: NutritionWidgetProps = {}) {
  ...
  return (
    <div className="bg-gradient-to-br from-surface-dark via-surface-dark to-purple-900/10 border border-primary/20 p-6 rounded-2xl backdrop-blur-xl shadow-xl hover:shadow-primary/10 transition-all duration-300 group relative overflow-hidden isolate">
      {/* Animated gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 via-transparent to-blue-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 pointer-events-none"></div>
