...
import { useMuscleHeatmap } from '@/features/dashboard/hooks/useMuscleHeatmap'
...
export function MuscleHeatmap({ userId }: MuscleHeatmapProps = {}) {
  ...
  return (
    <div className="bg-gradient-to-br from-surface-dark via-surface-dark to-surface-dark/50 border border-primary/20 rounded-2xl p-5 backdrop-blur-xl shadow-xl relative overflow-hidden group isolate">
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 pointer-events-none"></div>
